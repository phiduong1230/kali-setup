# 🎉 kali-setup - Easy Setup for Kali Linux
...
5. **Navigate to the Download Directory**: Use the command `cd ~/Downloads` (or wherever you saved the file) to access your downloads.
6. **Make the Script Executable**: Type the command `chmod +x kali-setup*.sh` to allow the script to run.
7. **Run the Script**: Execute the script by typing `./kali-setup*.sh`. Follow the prompts in the terminal to complete the setup.
